...
import net.gabor7d2.pcbuilderold.gui.dialogs.ProgressDialog;
import net.gabor7d2.pcbuilderold.gui.dialogs.ProgressDialogType;
...
import static net.gabor7d2.pcbuilderold.utils.FileUtils.*;
...
public class FileWorker extends SwingWorker<FileOperationData<String>, Void> implements ProgressDialog.DialogClosingListener {
    ...
    public FileWorker(JFrame parentFrame, boolean modal, int maxProgressInBytes) {
        ...
        if (parentFrame != null) {
            dialog = new ProgressDialog(parentFrame, new ProgressDialogType(WindowConstants.DO_NOTHING_ON_CLOSE, false, modal, this));
