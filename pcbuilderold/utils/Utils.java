...
public final class Utils {
    ...
    /**
     * Posts an event to the EventQueue
     *
    ...
    public static String readTextFromJar(String filePathInJar) {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(Utils.class.getResourceAsStream(filePathInJar), StandardCharsets.UTF_8))) {
            String line;
