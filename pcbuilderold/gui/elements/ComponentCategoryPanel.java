...
import net.gabor7d2.pcbuilderold.components.Component;
import net.gabor7d2.pcbuilderold.utils.Utils;
import net.gabor7d2.pcbuilderold.gui.dialogs.ImagePreviewDialog;
...
public class ComponentCategoryPanel {
    ...
    public ComponentCategoryPanel(String categoryName, String displayName, List components, Dimension previewPanelSize, Dimension itemSize, String categoryUrl, int selectedIndex) {
        url = categoryUrl;
        name = categoryName;
    ...
    public ComponentCategoryPanel(String categoryName, String displayName, List components, String categoryUrl, int selectedIndex) {
    ...
    public class CategoryPreview extends JPanel implements MouseListener {
        ...
        public CategoryPreview(Dimension size) {
            ...
            JLabel nameLabel = new JLabel(ComponentCategoryPanel.this.displayName);
...
//        }
    ...
    public class CategoryItem extends JPanel implements MouseListener, KeyListener {
        ...
        public CategoryItem(Component component, Dimension size) {
            ...
            ComponentCategoryPanel.this.buttonGroup.add(radioButton);
            add(radioButton);
            ...
            SelectableLabel brand = new SelectableLabel(component.getBrand(), "brand", this).centerText();
            ...
            SelectableLabel price = new SelectableLabel(String.valueOf(component.getPrice()), "price", this).centerText();
            ...
            switch (e.getKeyCode()) {
                ...
                case KeyEvent.VK_PAGE_UP:
                    if (previewCompIndex > 0) {
                        ...
                        String title = "Preview: " + currentComp.getBrand() + " " + currentComp.getModelNumber();
        ...
        private void showComponentPreview(Component comp) {
            ...
            String title = "Preview: " + comp.getBrand() + " " + comp.getModelNumber();
    ...
    public interface CategoryItemListener {
        void itemSelected(ComponentCategoryPanel category, CategoryItem item, int index);
    }
}
