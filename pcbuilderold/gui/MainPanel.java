...
import net.gabor7d2.pcbuilderold.components.ComponentManager;
import net.gabor7d2.pcbuilderold.components.StateChangeListener;
import net.gabor7d2.pcbuilderold.gui.elements.*;
...
public class MainPanel extends JPanel implements ActionListener, StateChangeListener {
    ...
    @Override
    public void loaded(String type, String displayName, boolean enabled, List<net.gabor7d2.pcbuilderold.components.Component> affectedComponents, String categoryUrl, int selIndex) {
        addCategory(new ComponentCategoryPanel(type, displayName, affectedComponents, categoryUrl, selIndex), enabled);
    }

    @Override
    public void reloaded(String type, String displayName, boolean enabled, List<net.gabor7d2.pcbuilderold.components.Component> affectedComponents, String categoryUrl, int selIndex) {
        addCategory(new ComponentCategoryPanel(type, displayName, affectedComponents, categoryUrl, selIndex), enabled);
    }
