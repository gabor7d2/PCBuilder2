...
public class ScrollablePanel extends JPanel implements Scrollable {
    ...
    public IncrementInfo getScrollableBlockIncrement(int orientation) {
        return orientation == HORIZONTAL ? horizontalBlock : verticalBlock;
    }
    ...
    public IncrementInfo getScrollableUnitIncrement(int orientation) {
        return orientation == HORIZONTAL ? horizontalUnit : verticalUnit;
    }
    ...
    public int getScrollableUnitIncrement(Rectangle visible, int orientation, int direction) {
        return getScrollableIncrement(horizontalUnit, verticalUnit, visible, orientation);
    }

    @Override
    public int getScrollableBlockIncrement(Rectangle visible, int orientation, int direction) {
        return getScrollableIncrement(horizontalBlock, verticalBlock, visible, orientation);
    }

    private int getScrollableIncrement(IncrementInfo horizontalInfo, IncrementInfo verticalInfo, Rectangle visible, int orientation) {
        switch (orientation) {
            case HORIZONTAL:
                return getScrollableIncrement(horizontalInfo, visible.width);
            case SwingConstants.VERTICAL:
                return getScrollableIncrement(verticalInfo, visible.height);
            default:
                throw new IllegalArgumentException("Invalid orientation: " + orientation);
        }
    }
