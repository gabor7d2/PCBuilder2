...
public class ImageLabel extends JLabel {
     ...
     */
    public ImageLabel(String imagePath, ImageLabel imageLabel, int width, int height) {
     ...
     * @param height     The height of the label
     */
    public ImageLabel(String imagePath, Icon labelImage, int width, int height) {
        this.imagePath = imagePath;
        this.width = width;
        this.height = height;
        currentReloadCount = RELOAD_COUNT;
    ...
    public ImageLabel(String imagePath, int width, int height) {
        this(imagePath, width, height, true);
    }
    ...
    public void setBorder(Color color, int thickness) {
        ...
        GUIUtils.freezeSize(this, getWidth() + thickness * 2, getHeight() + thickness * 2);
    }
    ...
    public void updateImage(ImageIcon labelImage) {
        GUIUtils.freezeSize(this, labelImage.getIconWidth(), labelImage.getIconHeight());
        setIcon(labelImage);
    }
