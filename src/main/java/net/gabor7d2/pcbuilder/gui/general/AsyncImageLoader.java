...
import static net.gabor7d2.pcbuilder.gui.general.ImageLoader.loadImageIconFromClasspath;
import static net.gabor7d2.pcbuilder.gui.general.ImageLoader.loadImageIconFromFile;
 ...
 * {@link AsyncImageLoader#processQueue()} when desired, which will start executing the image load tasks.
 * <p></p>
 * If you wish to discard the tasks that haven't finished loading images yet (because you do not need them anymore),
 * use {@link AsyncImageLoader#discardBackgroundTasks()},
...
public class AsyncImageLoader {
     ...
     * The queue has to be manually processed by calling {@link AsyncImageLoader#processQueue()}
     * when desired.
     *
