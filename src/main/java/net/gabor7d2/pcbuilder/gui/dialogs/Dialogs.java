package net.gabor7d2.pcbuilder.gui.dialogs;

import net.gabor7d2.pcbuilder.utils.FileUtils;
...
public class Dialogs {
    ...
    /**
     * Creates a progress dialog that can be shown using {@link ProgressDialog#setVisible}
     *
     * @param type The type of the progress dialog, any value from {@link ProgressDialog.Type}
     * @param title The title of the progress dialog, if null then "Loading..." is used
     * @return The created ProgressDialog ready to be shown or modified
     */
    public ProgressDialog createProgressDialog(ProgressDialogType type, String title) {
        return new ProgressDialog(parentFrame, type, title);
    }
}
